...
public class EasingPos2D : MonoBehaviour
{
    ...
    public Vector2 iniValue; // Valor de inicio de la animación
    public Vector2 finalValue; // Valor final de la animación
    private Vector2 deltaValue; // Incremento o variación de los valores, final - inicial
